function getBotResponse(input) {
    ...
    if (input == "hello") {
        ...
        return "Here's our menu: <br /><br /> Americano - Hot Espresso (12 OZ) - $5.00 <br /> Caffe Latte - Steamed Milk (12 OZ) - $5.00 <br /> Salted Caramel Espresso (12 OZ) - $5.00 <br /> Cafe Mocha Espresso (12 OZ) - $5.00 <br /> Spanish Latte Espresso (12 OZ) - $5.00 ";
    } else if (input == "about") {
        return "Hi there! <br /><br /> <strong>CoffeeShop Brewed Coffee</strong> is a coffee shop and retailer in Zambales, Philippines.";
    } else if (input == "contact") {
        return "Here's our contact information: <br /><br /> <strong>Email:</strong> abfiguerrez18@gmail.com <br /> <strong>Phone Number:</strong> 0917 134 1422 <br /> <strong>Messenger:</strong> @CoffeeShop <br /> <strong>Address:</strong> Laoag, San Marcelino, Zambales ";
